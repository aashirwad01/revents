...
export default function HomePage({history}) {
  ...
  return (
    <Card style={cardStyle}>
      ...
      >
        {/* <Typography variant='h2' style={{marginBottom:"5rem"}}>Revents</Typography> */}
      </CardHeader>
    </Card>
  );
}
