    ...
    <div>
       <Box >
        <Card elevation={3} sx={{marginTop:'1rem'}} >
            <CardHeader
            avatar={
                <Avatar src={event.hostPhotoURL} alt="avatar"></Avatar>
            }
            title={event.title}
        ...
        >
                    ...
                    flexDirection: 'row',
                        ...
                        {event.attendees.map(attendee =>(
                             <ListItem sx={{paddingRight:'0rem',paddingLeft:"0rem",width:'5%',}} key={attendee.id}>
               ...
               <Card sx={{display:'flex',justifyContent:'space-between', alignItems:'center' , padding:'0.5rem 0'}}>
                   <Typography sx={{marginLeft:'1rem'}} >{event.description}</Typography>
