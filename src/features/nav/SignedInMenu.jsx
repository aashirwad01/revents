...
//   <Avatar src="/assets/user.png" sx={{marginLeft:'1rem'}}/>
  return (
    ...
    <InputLabel sx={{color:'white'  }} id="demo-simple-select-label">User</InputLabel>
      <Select 
      sx={{width:{sm:'6rem',xs:'0rem'},}}
        ...
        IconComponent={()=> <Avatar sx={{marginRight:'0.23rem',width:{sm:40,xs:'1rem'},height:{sm:40,xs:'1rem'}}}  src="/assets/user.png"/> }
      >
